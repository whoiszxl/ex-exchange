 ...
 * 配置文件加密工具
 * <p>
 * 配置在yml里的钱包rpc账号密码需要通过加密后再使用，保证资金安全。
...
public class EncryptPropertiesUtils {
    ...
    public static void main(String[] args) {
        String dbUrl = "localhost:3306/tuespay";
        String dbUsername = "tuespay";
        String dbPassword = "password123";
        String nodeUrl = "";

        encrypt("your secret", dbUrl);
        encrypt("your secret", dbUsername);
        encrypt("your secret", dbPassword);
        encrypt("your secret", nodeUrl);
